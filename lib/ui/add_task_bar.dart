...
import 'package:flutterapp/controllers/task_controller.dart';
...
import 'package:flutterapp/ui/widgets/input_field.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  _appBar(BuildContext context) {
    return AppBar(
      ...
      actions: [
        const CircleAvatar(
          backgroundImage: AssetImage("images/meo.png"),
        ),
        SizedBox(
          width: 20,
        ),
